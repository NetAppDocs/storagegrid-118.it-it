...
XML raw ILM
 a| 
File di criteri ILM attivo. Contiene dettagli sulle policy ILM attive, come ID del pool di storage, comportamento di acquisizione, filtri, regole e descrizione. Contiene inoltre l'XML per il criterio ILM predefinito.
