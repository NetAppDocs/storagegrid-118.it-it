...
* Un gruppo ha che include solo appliance SG100 o SG1000 e nodi software basati su VMware può fornire connessioni altamente disponibili per link:../admin/manage-s3-select-for-tenant-accounts.html["S3 tenant che utilizzano S3 Select"].
