...
Specificare https://docs.netapp.com/us-en/storagegrid-appliances/commonhardware/checking-dns-server-configuration.html["Informazioni sul server DNS"^] Consente di utilizzare nomi host FQDN (Fully Qualified Domain Name) piuttosto che indirizzi IP per le notifiche e-mail e AutoSupport.
